...
prefix = '!'
shp = '⬡'
owner = "447537107290@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["DrakerBot", "3.0"];
console.log(color(figlet.textSync('Draker Bot.', {
font: 'Standard',
...
console.log(color(`[ • CREADOR DADDY DRAKER • ]` ,'cyan'))
...
whitespaceBreak: false
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`447537107290@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'Draker',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Draker;;;\nFN:Creador\nitem1.TEL;waid=447537107290:+44 7537 107290\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        client.sendMessage(anu.jid, "Hola Putas, Me Hacen Unas Mamadas¿?", "conversation");
      }
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
      ...
      if (anu.action == "promote") {
        ...
        teks = `${anu_user} Ola Nuevo Jefe :D`;
