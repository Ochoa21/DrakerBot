...
autoketik = false;
prefixStatus = true;
targetpc = "447537107290"; 
owner = "447537107290"; 
fakeyoi = "Daddy Draker"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`447537107290@s.whatsapp.net`]
...
/*const reply = (teks) => {
			cnf.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/447537107290?text=ola%20UwU`}}})
		}*/
...
"externalAdReply": {
                "title": `WhatsApp`,
                "body": `wa.me/447537107290`,
                "mediaType": "10",
                "mediaUrl": `wa.me/447537107290`,
                "thumbnailUrl": "https://i.ibb.co/QJRWXb9/IMG-20211107-WA0044.jpg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/447537107290`,
...
*「 DrakerBot 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `🌿MENU🌿`},type:1}]
              ...
              buttonsMessage = {footerText:'Daddy Draker', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Gracias por registrarse en DrakerBot*`)
		}, 2000)
        break
...
groups = cnf.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "447537107290@s.whatsapp.net"
        dtod = '447537107290'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
𝗡𝗼𝘁𝗮 : NO SPAM.
`
sendButLocation(from, `${menu}`,`𝘽𝙤𝙩 𝘽𝙮 Daddy Draker`, {jpegThumbnail:iye}, [{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPT'},type:1}], {contextInfo: { mentionedJid: [ptod,stod]}})
...
🌿${prefix}twitter <link>
`
sendButMessage(from, menu, `DrakerBot`, [
          {
            buttonId: `command`,
            buttonText: {
...
`
sendButMessage(from, menu, `ConfuBot`, [
          {
            buttonId: `command`,
            buttonText: {
              displayText: `⬡ VOLVER AL MENU `,
...
case 'writelist':
  ...
  🌿 ${prefix}folioright Daddy Draker
  🌿 ${prefix}folioleft Bot by Draker
  🌿 ${prefix}writedown Daddy Draker
  🌿 ${prefix}writeleft Draker`)
  break
case 'folioleft':
if (!c) return reply('Donde esta el texto??')
reply(mess.wait)
